    ...
    <div class="card-body" id="view-transaction">
        <div class="row">
            <div class="col">
                ...
                <div class="card w-100 p-4">
                    ...
                    <div class="card-body py-0">
                        ...
                        <div class="row">
                            <div class="col-2">
                                <img class="img-fluid"
                                     src="<c:url value="resources/main/icons/category_icon/cat_1.png" />" alt="des" />
                            </div>
                            <div class="col-6">
                                <div class="row">
                                    <p>
                                        <span class="d-block">Award</span>
                                ...
                                <div class="row float-right">
                                    <form action="#" class="delete-transaction-form">
                                        ...
                                        <button type="submit" class="btn btn-circle btn-danger"
                                                ...
                                                data-original-title="Delete transaction"><i
                ...
                <div class="card w-100 p-4">
                    <div class="card-header">
                        <h3 class="card-title m-t-10">2019-10-10</h3>
                        <div class="float-right">
                            <p>-600000</p>
                        </div>
                    </div>
    ...
    <div class="card-footer text-center">
        <nav>
            <ul class="pagination pagination-rounded pagination-md float-right">
                ...
                <li class="page-item"><a class="page-link"
                                         data-toggle="tooltip"
                                         data-placement="right" title data-original-title="Next"> >> </a>
                </li>
            </ul>
        </nav>
    </div>
