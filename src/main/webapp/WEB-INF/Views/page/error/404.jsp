            ...
            <div class="error-content">
                <div class="card mb-0">
                    <div class="card-body text-center">
                        ...
                        <h4 class="mt-4"><i class="fa fa-exclamation-triangle text-warning"></i> Sorry but we
                            couldn't find this page</h4>
                        <p>We could not find the page you were looking for. Meanwhile, you may return to dashboard
